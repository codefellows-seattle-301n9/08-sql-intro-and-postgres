...
app.get('/new', (request, response) => {
  ...
  // #2 & #5 in the full-stack diagram correspond to the .get() and .sendFile() methods.
  // There are no interactions with any methods in article.js.
  // READ/RETRIEVE - accessing model of new article form html
...
app.get('/articles', (request, response) => {
  // COMMENTED: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 Querying the database & #4 Result from database query
  // Interacting with the .fetchAll()/loadAll() methods (selecting all fields of articles in table)
  // READ/RETRIEVE of CRUD is being enacted.
...
app.put('/articles/:id', (request, response) => {
  // COMMENTED: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 & #4 - requesting to update data and expecting response
  // updateRecord() method
  // READ & UPDATE - searches for and updates a particular article with id
  client.query(
    `UPDATE articles
    SET
...
app.delete('/articles/:id', (request, response) => {
  // COMMENTED: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 & #4 of diagram (request to delete particular row/fields)
  // deleteRecord() method
  // DELETE
  client.query(
...
app.delete('/articles', (request, response) => {
  // COMMENTED: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 & #4 (requesting to clear all records/fields from table without deleting table)
...
function loadDB() {
  // COMMENTED: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3 & #4
  // fetchAll() and insertRecord() because it also calling the loadArticles() method
  // CREATE/READ - creates new table/reads article JSON data
  client.query(`
